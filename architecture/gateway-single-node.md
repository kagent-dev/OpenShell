...
- The OpenShell Helm chart grants the gateway service account cluster-scoped read access to core `nodes` so GPU sandbox admission can verify allocatable GPU capacity before creating a sandbox.
